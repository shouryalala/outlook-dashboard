$(function() {
    ...
    function renderInbox() {
        ...
        getUserInboxNext(function(messages, error){            
            alert("" + messages);
          ...
          getAccessToken(function(accessToken){
                if(accessToken){
                    ...
                    try {
                        ...
                        alert(`SUCCESS!Graph request returned: ${JSON.stringify(result, null, 2)}`);
                      } catch (err) {
                        //parms.message = 'Error retrieving messages';
                        //parms.error = { status: `${err.code}: ${err.message}` };
                        //parms.debug = JSON.stringify(err.body, null, 2);
                        //res.render('error', parms);
                        alert("ERROR!" + JSON.stringify(err.body, null, 2));
                      }
                }
                else{
                    alert("API error");
